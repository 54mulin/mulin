        ...
        ? b.ishwscroll && f.hastransition && b.opt.usetransition
          ? ((this.prepareTransition = function (c, e) {
            ...
            (this.doScrollLeft = function (c, f) {
              var g = b.scrollrunning ? b.archivescrolly : b.getScrollTop();
              b.doScrollPos(c, g, f);
            }),
            (this.doScrollTop = function (c, f) {
              var g = b.scrollrunning ? b.archivescrollx : b.getScrollLeft();
              b.doScrollPos(g, c, f);
            }),
            (this.doScrollPos = function (c, e, g) {
              var h = b.getScrollTop(),
                l = b.getScrollLeft();
              (0 > (b.archivescrolly - h) * (e - h) ||
                0 > (b.archivescrollx - l) * (c - l)) &&
                b.cancelScroll();
              !1 == b.opt.bouncescroll &&
                (0 > e ? (e = 0) : e > b.page.maxh && (e = b.page.maxh),
                0 > c ? (c = 0) : c > b.page.maxw && (c = b.page.maxw));
              if (b.scrollrunning && c == b.archivescrollx && e == b.archivescrolly)
                return !1;
              b.archivescrolly = e;
              b.archivescrollx = c;
              b.archivescrollspeed = g || !1;
              if (b.timer) return !1;
              b.timer = setTimeout(function () {
                ...
                l =
                  b.archivescrollspeed && 1 < b.archivescrollspeed
                    ? b.archivescrollspeed
                    : b.getTransitionSpeed(l);
                b.archivescrollspeed &&
                  1 >= b.archivescrollspeed &&
                  (l *= b.archivescrollspeed);
                ...
                0 < l &&
                  (!b.scrollrunning &&
                    ...
                    b.onscrollstart.call(b, {
                      ...
                      current: { x: h, y: g },
                      request: { x: c, y: e },
                      end: { x: b.archivescrollx, y: b.archivescrolly },
                      speed: l,
                    }),
                  f.transitionend
                    ? b.scrollendtrapped ||
                  ...
                  (b.timerscroll = {
                    bz: new BezierClass(g, b.archivescrolly, l, 0, 0, 0.58, 1),
                    bh: new BezierClass(h, b.archivescrollx, l, 0, 0, 0.58, 1),
                  }),
                  b.cursorfreezed ||
                ...
                b.synched("doScroll-set", function () {
                  ...
                  b.setScrollTop(b.archivescrolly);
                  b.setScrollLeft(b.archivescrollx);
            ...
            (this.onScrollEnd = function () {
              ...
              if (c != b.archivescrolly || e != b.archivescrollx)
          ...
          : ((this.doScrollLeft = function (c, f) {
            ...
            (this.doScrollPos = function (c, f, g) {
              function e() {
                ...
                if (b.dst.ay) {
                  var d = b.bzscroll
                    ...
                    g = d - sy;
                  if (
                    (0 > g && d < b.archivescrolly) ||
                    (0 < g && d > b.archivescrolly)
                  )
                    d = b.archivescrolly;
                  b.setScrollTop(d);
                  d == b.archivescrolly && (c = 1);
                } else c = 1;
                ...
                if (b.dst.ax) {
                  ...
                  g = f - sx;
                  if (
                    (0 > g && f < b.archivescrollx) ||
                    (0 < g && f > b.archivescrollx)
                  )
                    f = b.archivescrollx;
                  b.setScrollLeft(f);
                  f == b.archivescrollx && (c += 1);
                } else c += 1;
                2 == c
                  ? ((b.timer = 0),
                    (b.cursorfreezed = !1),
                    ...
                    f != b.archivescrollx || d != b.archivescrolly
                      ? b.doScrollPos(f, d)
                      : b.onscrollend &&
                        b.onscrollend.call(b, {
                          type: "scrollend",
              ...
              if (b.timer && b.archivescrolly == f && b.archivescrollx == c) return !0;
              b.timer && w(b.timer);
              b.timer = 0;
              var h = b.getScrollTop(),
                l = b.getScrollLeft();
              (0 > (b.archivescrolly - h) * (f - h) ||
                0 > (b.archivescrollx - l) * (c - l)) &&
                b.cancelScroll();
              b.archivescrolly = f;
              b.archivescrollx = c;
              if (!b.bouncescroll || !b.rail.visibility)
                0 > b.archivescrolly
                  ? (b.archivescrolly = 0)
                  : b.archivescrolly > b.page.maxh && (b.archivescrolly = b.page.maxh);
              if (!b.bouncescroll || !b.railh.visibility)
                0 > b.archivescrollx
                  ? (b.archivescrollx = 0)
                  : b.archivescrollx > b.page.maxw && (b.archivescrollx = b.page.maxw);
              b.dst = {};
              b.dst.x = c - l;
              b.dst.y = f - h;
              b.dst.px = l;
      ...
      this.doScrollBy = function (c, f) {
        var g = 0,
          g = f
            ...
            : (b.timer ? b.archivescrolly : b.getScrollTop(!0)) - c;
        if (b.bouncescroll) {
      ...
      this.doScrollLeftBy = function (c, f) {
        var g = 0,
          g = f
            ...
            : (b.timer ? b.archivescrollx : b.getScrollLeft(!0)) - c;
        if (b.bouncescroll) {
